...
def do_search():
    ...
    if mov.get() == "Kraljica":
        initial_state = QueenState
    elif mov.get() == "Top":
        initial_state = RookState
    elif mov.get() == "Konj":
        initial_state = KnightState
    else:
...
moves = ["Konj", "Top", "Kraljica", "Default"]
mov = ttk.Combobox(ui, values = moves, state = "readonly")
...
mov.grid(row = 6, column = 0, padx = 10, pady = 10)
